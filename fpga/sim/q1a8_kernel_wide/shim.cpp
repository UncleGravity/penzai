...
void dut_set_w(Dut *d, const uint32_t *w, int valid) {
    // s_axis_tdata is a 256-bit packed signal -> VlWide<8> of little-endian words.
    for (int i = 0; i < 8; i++) d->t->s_axis_tdata[i] = w[i];
