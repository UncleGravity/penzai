...
//! `fpga/rtl/attention/flash_luts.vh` (a generated artifact). The formulas are
//! shared with the attention verification model:
//!
//!   FLASH_EXP_LUT[k]   = 2^(−k/2^B)      for exp, af∈[0,1)
//!   FLASH_RECIP_LUT[k] = 1/(1 + k/2^B)   for recip, sig∈[1,2)
//!
...
pub fn main(init: std.process.Init) !void {
    ...
    cursor += (try std.fmt.bufPrint(buf[cursor..], "// Generated from fpga/build/generators/flash_luts.zig - do not edit.\n", .{})).len;
