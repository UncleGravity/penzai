# q1a8-w64-f100 — KR260 Q1A8 matmul bitstream (v5)

The deployable gateware for the PL Q1A8 matmul: the narrow `q1a8_kernel` at a
64-bit datapath and 100 MHz, fed by two AXI DMAs. This is the **v5** bitstream —
...
./build.sh                          # variant from config.env (w64-f100)
```
...
routing isn't timing-clean, and fetches `out/penzai-q1a8-matmul-w64-f100.bit(.bin)`.
...
- **Same app name as v4.** This replaces `penzai-q1a8-matmul` in the board's
