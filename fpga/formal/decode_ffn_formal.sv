...
`endif
    ...
    decode_top dut (
        ...
        .formal_inject_inactive_norm_owner(1'b0),
        .formal_inject_inactive_residual_owner(1'b0),
        .formal_inject_ownerless_rsp(1'b0),
        .formal_inject_ownerless_rsp_error(1'b0),
        .formal_inject_q8_cfg_fault(1'b0),
