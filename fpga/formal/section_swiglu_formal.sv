...
// Control-only proof boundary for section_swiglu. Arithmetic values and FIFO
...
module section_swiglu_formal(input wire clk);
    ...
    section_swiglu #(.RESERVE_DEPTH(CAPACITY)) dut (
    ...
    always @(posedge clk) begin
        ...
        if (rst_n) begin
            ...
            assert(in_ready == (!abort && (formal_reserved_count < CAPACITY)));
