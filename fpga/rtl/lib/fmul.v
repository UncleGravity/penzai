...
// parameters. The exponent stays 8-bit for both formats. The truncating
// (MANT_W+1)^2 mantissa product is forced into a DSP and runs register-to-register.
//
...
// at MUL_PIPE=0 both DSPs evaluate combinationally in one cycle. MUL_PIPE=1 lets
// retiming place a register in the cascade, one DSP per cycle, without changing the
// value. Wide-multiply consumers opt in; everything else keeps latency 3.
