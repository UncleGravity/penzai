...
fn addFormalSteps(b: *std.Build) void {
    ...
    const section_rmsnorm_scalar_pipeline_run = b.addSystemCommand(&.{
        "sby",
        "-f",
        "--sequential",
        "--prefix",
        ".zig-cache/sby/section_rmsnorm_scalar_pipeline",
        "fpga/formal/section_rmsnorm_scalar_pipeline.sby",
    });
    const section_rmsnorm_scalar_pipeline_step = b.step(
        "formal-section-rmsnorm-scalar-pipeline",
        "Prove weighted RMSNorm scalar ownership, cleanup, abort, and restart",
    );
    section_rmsnorm_scalar_pipeline_step.dependOn(
        &section_rmsnorm_scalar_pipeline_run.step,
    );
    ...
    formal.dependOn(section_rmsnorm_scalar_pipeline_step);
...
const section_rmsnorm_scalar_pipeline_rtl = [_][]const u8{
...
fn addRtlSteps(b: *std.Build, target: std.Build.ResolvedTarget, optimize: std.builtin.OptimizeMode) void {
    ...
    const section_rmsnorm_scalar_pipeline_lint = b.addSystemCommand(&.{
        "verilator",                         "--lint-only",                                "-Wall",                                      "-Wno-DECLFILENAME",
        "-Wno-UNUSEDSIGNAL",                 "-Wno-UNUSEDPARAM",                           "+incdir+fpga/rtl/numeric",                   "--top-module",
        "section_rmsnorm_scalar_pipeline",   "fpga/rtl/section_rmsnorm_scalar_pipeline.v", "fpga/rtl/section_rmsnorm_reduce.v",          "fpga/rtl/section_rmsnorm_frontend.v",
        ...
        "fpga/rtl/numeric/fmul.v",           "fpga/rtl/numeric/fadd.v",                    "fpga/rtl/section_rmsnorm_weighted_source.v", "fpga/rtl/section_rmsnorm_mul_rne.v",
    });
    const section_rmsnorm_q8_pipeline_lint = b.addSystemCommand(&.{
        "verilator",                           "--lint-only",                            "-Wall",                                      "-Wno-DECLFILENAME",
        "-Wno-UNUSEDSIGNAL",                   "-Wno-UNUSEDPARAM",                       "+incdir+fpga/rtl/numeric",                   "--top-module",
        "section_rmsnorm_q8_pipeline",         "fpga/rtl/section_rmsnorm_q8_pipeline.v", "fpga/rtl/section_rmsnorm_scalar_pipeline.v", "fpga/rtl/section_rmsnorm_reduce.v",
        "fpga/rtl/section_rmsnorm_frontend.v", "fpga/rtl/section_rmsnorm_loader.v",      "fpga/rtl/section_rmsnorm_maxexp.v",          "fpga/rtl/section_rmsnorm_sumsq.v",
        "fpga/rtl/section_rmsnorm_inv.v",      "fpga/rtl/numeric/fmul.v",                "fpga/rtl/numeric/fadd.v",                    "fpga/rtl/section_rmsnorm_weighted_source.v",
    ...
    lint_step.dependOn(&section_rmsnorm_scalar_pipeline_lint.step);
    ...
    const section_rmsnorm_scalar_pipeline_cosim = addCosim(b, target, optimize, "test-rtl-section-rmsnorm-scalar-pipeline", "Verilator cosim: external or resident RMSNorm through exact weighted scalar publication", "section_rmsnorm_scalar_pipeline", "fpga/sim/section_rmsnorm_scalar_pipeline", &section_rmsnorm_scalar_pipeline_rtl, .section);
    ...
    rtl_cosim.dependOn(section_rmsnorm_scalar_pipeline_cosim);
